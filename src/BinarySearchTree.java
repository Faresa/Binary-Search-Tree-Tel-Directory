...
/*
try {
	String entry =  (String) d ;String [] entryArray = entry.split(" ~");
	String fullName = entryArray [0];

	String nodeData =  (String) node.data; String [] nodeDataArray = nodeData.split(" ~");
	String nodeCompare = nodeDataArray [0] ;



	if (fullName.compareTo (nodeCompare) == 0)
         return node;
